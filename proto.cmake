...
set(WBT_PROTO_PATH "${CMAKE_CURRENT_BINARY_DIR}/src/protos")

file(GLOB_RECURSE wbt_proto_files ${WBT_PROTO_PATH}/*.proto)
...
#    get_filename_component(PROTO_DIR ${WBT_PROTO_FILE} DIRECTORY)
    get_filename_component(WBT_PROTO_NAME ${WBT_PROTO_FILE} NAME_WE)
    set(WBT_PROTO_HDR ${WBT_GENERATED_PROTOBUF_PATH}/${WBT_PROTO_NAME}.pb.h)
    set(WBT_PROTO_SRC ${WBT_GENERATED_PROTOBUF_PATH}/${WBT_PROTO_NAME}.pb.cc)
    set(WBT_PROTO_GRPC_HDR ${WBT_GENERATED_PROTOBUF_PATH}/${WBT_PROTO_NAME}.grpc.pb.h)
    set(WBT_PROTO_GRPC_SRC ${WBT_GENERATED_PROTOBUF_PATH}/${WBT_PROTO_NAME}.grpc.pb.cc)
...
include_directories("${WBT_GENERATED_PROTOBUF_PATH}")